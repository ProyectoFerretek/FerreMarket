...
import { 
  ...
  CircleDot, CircleDashed, Eye, X, ChevronDown, Calculator
} from 'lucide-react';
                  ...
                  <div className="flex-grow space-y-3">
                    ...
                    <div className="space-y-2">
                      {/* <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-medium">{producto.stock} unidades</span>
                      </div> */}

                      <div className={`flex items-center justify-between p-2 rounded-md bg-zinc-100`}>
                        <div className="flex items-center space-x-2">
                      ...
                      <div className={`flex items-center justify-between p-2 rounded-md ${stockInfo.bgColor}`}>
                        <div className="flex items-center space-x-2">
                          {stockInfo.icon}
